...
const checkDriverAvailability = async () => {
    try {
        ...
        const driversResponse = await axios.get("http://10.0.2.2:40055/api/drivers/available", { headers });
        ...
        const bookingsResponse = await axios.get("http://10.0.2.2:40055/api/bookings/active", { headers });
