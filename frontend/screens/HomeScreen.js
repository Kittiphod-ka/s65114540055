...
const checkDriverAvailability = async () => {
    try {
        ...
        const driversResponse = await axios.get("http://26.120.17.211:5000/api/drivers/available", { headers });
        ...
        const bookingsResponse = await axios.get("http://26.120.17.211:5000/api/bookings/active", { headers });
