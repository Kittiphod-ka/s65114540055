...
const EditSlideCar = () => {
  ...
  const fetchSlideCar = async () => {
    try {
      ...
      const response = await axios.get(`http://26.120.17.211:5000/api/slidecars/${id}`);
  ...
  const fetchDrivers = async () => {
    try {
      ...
      const response = await axios.get("http://26.120.17.211:5000/api/drivers");
  ...
  const handleUpdate = async (e) => {
    e.preventDefault();
    try {
      await axios.put(`http://26.120.17.211:5000/api/slidecars/${id}`, slideCar);
